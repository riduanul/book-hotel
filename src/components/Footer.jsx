const Footer = () => {
  return (
    ...
    <footer className="bg-gradient-to-r from-sky-600 to-sky-500 font-sans dark:bg-gray-900">
        <div className="container px-6 py-12 mx-auto">
            ...
            <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2024 Md. Riduanul Haque. All rights reserved.</p>
        </div>
    </footer>
  );
};
